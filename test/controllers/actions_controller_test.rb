...
class ActionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action" do
    assert_difference('Action.count') do
      post actions_url, params: { action: { description: @action.description, inactive: @action.inactive, name: @action.name } }
    end
  ...
  test "should update action" do
    patch action_url(@action), params: { action: { description: @action.description, inactive: @action.inactive, name: @action.name } }
